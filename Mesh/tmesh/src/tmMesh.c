 ...
 */
#include "../include/tmesh/tmTypedefs.h"
...
//  FILE *fp_py;
  ...
  fp = fopen("mesh_output.txt", "w");
//  fp_py = fopen("mesh_outpy.txt", "w");

  if (fp == NULL) {
      printf("Error opening mesh_output.txt file.\n");
      return;
  }

//  if (fp_py == NULL) {
//      printf("Error opening mesh_outpy.txt file.\n");
//      return;
//  }
